"""Policy engine — rule-based access control for Veeam MCP tools.

Rules are loaded from ``~/.veeam-aiops/rules.yaml`` with hot-reload on file change.
"""
...
_log = logging.getLogger("veeam-aiops.policy")
